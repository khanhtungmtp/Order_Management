...
import { FilteredTreeResult, TreeNode } from './filtered-tree-result';


@Injectable()
export class DepartmentTreeSearchService {
  private deptTreeService = inject(DepartmentTreeService);
